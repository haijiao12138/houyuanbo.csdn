<template>
    <div>
        ...
        <el-row>
            <el-form :inline="true" :model="searchForm" ref="searchForm" class="demo-form-inline" >
                <el-form-item label="姓名" prop="name">
                    <el-input v-model.trim="searchForm.name" placeholder="姓名">
                    </el-input>
                </el-form-item>
        ...
        <!-- 添加和删除按钮区域 -->
        <el-row>
            <el-button type="primary" @click="addHandleClick" v-auth="['/test/saveOrUpdate']">添加</el-button>
            <el-button type="primary" @click="batchDelete" v-auth="['/test/delete']">批量删除</el-button>
            <el-button type="primary" @click="exportExcel" v-auth="['/test/export']">
                导出数据
            </el-button>
            <p />
        </el-row>
        ...
        <el-table :data="tableData" border style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column fixed="right" label="操作" >
                <template slot-scope="scope">
                    <el-button type="text" @click="detailHandleClick(scope.row)" v-auth="['/test/saveOrUpdate']" size="small">详情</el-button>
        ...
        <el-dialog :title="isEditor ? '编辑' : '添加'" :visible.sync="dialogAddFormVisible">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button @click="resetDialogFormData" v-if="!isEditor">重 置</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            resetSearchForm: function () {
                //重置表单数据
                let _resetFormData = this.$options.data().searchForm;
                this.searchDate = '';
                this.$data.searchForm = _resetFormData;
                this.pageList();
            },
            //重置编辑弹出框表单的数据
            resetDialogFormData:function(){
                this.$nextTick(() => {
            ...
            detailHandleClick: function (row) {
                console.log(row)
                this.$router.replace({
                    path: '/hid/child'
                });
                ...
                this.axios({
                    ...
                    .then((res) => {
                        ...
                        if (code == 200) {
                            ...
                            window.location.href = "/profile/download/" + res.data.data;
                        }
                    })
                    .catch((error) => {
                        console.log(error);
